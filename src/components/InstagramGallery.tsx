...
const photos = [
  { src: "/images/insta-1.jpg", color: "#C4B59E" },
  { src: "/images/insta-2.jpg", color: "#3D5A3E" },
  { src: "/images/insta-3.jpg", color: "#8B7355" },
  { src: "/images/insta-4.jpg", color: "#B8976A" },
  { src: "/images/insta-5.jpg", color: "#2C2420" },
  { src: "/images/insta-6.jpg", color: "#C4B59E" },
];
    ...
    <section className="py-32 md:py-44 px-6 md:px-12">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
          {photos.map((photo, i) => (
            <ImageReveal key={i} delay={i * 0.08}>
              <motion.div
