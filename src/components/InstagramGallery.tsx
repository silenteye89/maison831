        ...
        <div className="text-center mb-14 md:mb-18">
          <FadeIn>
            <a
              ...
              className="text-[13px] tracking-[0.2em] uppercase text-stone/50 hover:text-brass transition-colors duration-500"
            >
              @maison831.kr
            </a>
          </FadeIn>
            ...
            <ImageReveal key={i} delay={i * 0.05}>
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: `url('${photo.src}')`, backgroundColor: photo.color }}
                />
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/25 transition-colors duration-500 flex items-center justify-center">
                  <svg className="w-5 h-5 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500" fill="currentColor" viewBox="0 0 24 24">
