...
export default function Contact() {
  return (
    <section id="contact" className="bg-ivory py-[120px] md:py-[140px] px-6 md:px-10">
      <div className="max-w-[1080px] mx-auto">
        <div className="text-center mb-16 md:mb-20">
          ...
          <FadeIn delay={0.14}>
            <p className="text-[15px] text-walnut max-w-[440px] mx-auto leading-[1.8]">프로젝트 문의, 공간 예약, 클래스 신청 등 무엇이든 편하게 연락해주세요.</p>
          </FadeIn>
        </div>
          ...
          {inquiries.map((q, i) => (
            <FadeIn key={q.title} delay={i * 0.06}>
              <a href="tel:010-8687-2129" className="group block bg-ivory p-8 md:p-10 hover:bg-cream/20 transition-colors duration-300">
                ...
                <p className="text-[15px] text-walnut leading-[1.8]">{q.description}</p>
              </a>
            </FadeIn>
          ))}
        </div>
        ...
        <FadeIn delay={0.15}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 pt-12 border-t border-stone/8">
            <div className="text-center md:text-left">
              ...
              <p className="text-[15px] leading-[1.8] text-dark-brown/80">경기도 성남시 수정구 고등로 3<br />현대지식산업센터 성남고등<br />8층 831호</p>
            </div>
            <div className="text-center">
              <p className="text-[12px] tracking-[0.15em] uppercase text-oak/35 mb-4">Contact</p>
              <p className="text-[15px] leading-[1.8]"><a href="tel:010-8687-2129" className="text-dark-brown/80 hover:text-brass transition-colors duration-300">010-8687-2129</a></p>
              <p className="text-[15px] leading-[1.8] mt-1"><a href="https://maison831.com" target="_blank" rel="noopener noreferrer" className="text-dark-brown/80 hover:text-brass transition-colors duration-300">maison831.com</a></p>
            </div>
